...
export default function BlogPage({ params }) {
  ...
  return (
    <article>
      <div className="mg-8 text-center relative w-full h-[70vh] bg-dark">
      ...
      <div className="grid grid-cols-12 gap-y-8 lg:gap-8 sxl:gap-16 mt-8 px-5 md:px-10">
        <div className="col-span-12 lg:col-span-4">
          <details
            className="border-[1px] border-solid border-dark text-dark rounded-lg p-4 sticky top-0
                ...
                return (
                  <li key={`#{heading.slug}`} className="py-1">
                    <a
                      ...
                      className="data-[level=two]:pl-0 data-[level=two]:pt-0
